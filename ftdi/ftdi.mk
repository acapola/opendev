...
WorkspacePath          := "F:\work\opendev\ftdi"
ProjectPath            := "F:\work\opendev\ftdi"
...
$(IntermediateDirectory)/check.cpp$(ObjectSuffix): check.cpp $(IntermediateDirectory)/check.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "F:/work/opendev/ftdi/check.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/check.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/safe_stream.cpp$(ObjectSuffix): safe_stream.cpp $(IntermediateDirectory)/safe_stream.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "F:/work/opendev/ftdi/safe_stream.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/safe_stream.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ftdi_raw_data_source.cpp$(ObjectSuffix): ftdi_raw_data_source.cpp $(IntermediateDirectory)/ftdi_raw_data_source.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "F:/work/opendev/ftdi/ftdi_raw_data_source.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ftdi_raw_data_source.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/crc32.cpp$(ObjectSuffix): crc32.cpp $(IntermediateDirectory)/crc32.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "F:/work/opendev/ftdi/crc32.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/crc32.cpp$(ObjectSuffix) $(IncludePath)
