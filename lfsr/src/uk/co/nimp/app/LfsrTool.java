...
public class LfsrTool {
    static String helpMessage(){
        ...
        msg+=tab+"- The reference sequence is searched inside the sequence generated by the reference LFSR\n";
        msg+="\n"+credits;
    ...
    public static void main(String[] args) throws IOException {
        ...
        if(null!=refSequence){
            ...
            if(null!=refLfsr) {
                ...
                System.out.println(describe(refLfsr,dispSeq,dispSeqStates));
            ...
            System.out.println(describe(lfsr,dispSeq,dispSeqStates));
            if(null!=refLfsr){
            ...
            if(endianness){
                ...
                for(int wordSize=1;wordSize<=maxWordSize;wordSize=2*wordSize) {
                    ...
                    for (int atomSize = 1; atomSize <= wordSize / 2; atomSize = 2 * atomSize) {
                        ...
                        System.out.println(describe(candidate,false,false));
                    }
                }
            }
    ...
    private static String describe(Lfsr l, boolean dispSeq,boolean dispSeqStates){
        if(l.getWidth()>100){
            String out = l.getPolynomial();
            out +="\nLarge polynomial, skip complete analysis. Use -lfsrPoly argument to get complete analysis.";
            return out;
        }else{
            return l.describe(dispSeq,dispSeqStates);
        }
    }
}
